...
def main() -> None:
    ...
    parser.add_argument("--audio-ablation", choices=("none", "zero", "feature-zero", "projected-zero", "shuffle"), default="none")
    parser.add_argument(
        "--zero-feature-dir",
        type=Path,
    ...
    if args.audio_ablation == "zero" and zero_cache is None:
